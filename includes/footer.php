<div class="col-md-4">
   ...
   <!-- jQuery -->
<!-- <script src="<?php echo APPURL;?>/https://code.jquery.com/jquery-3.6.0.min.js"></script> -->

<!-- Bootstrap JavaScript -->
<!-- <script src="<?php echo APPURL;?>/https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script> -->

	<!-- <script src="<?php echo APPURL;?>/https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script> -->
 <!-- <script src="<?php echo APPURL;?>/js/bootstrap.js"></script> -->
	<!-- jQuery library -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<!-- Popper.js library for Bootstrap tooltips and popovers -->
